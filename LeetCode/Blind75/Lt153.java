 ...
 * rotated 4 times becomes: 4,5,6,7,0,1,2
 * rotated 7 times becomes: 0,1,2,4,5,6,7
 * 
 * Example: 3,4,5,1,2
 * rotated 3 times: 1,2,3,4,5
 * 
 * return min element of this array
 */
public class Lt153 {
    ...
    public static int findMin(int[] nums) {
        ...
        // Binary search way
        while (right >= left) {
            // Find the mid element everytime left is increased and still less than right
